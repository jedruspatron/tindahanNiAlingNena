		...
		<table class="table table-stripped table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td class="item_quantity"><input type="number" value="<?php echo $qty;?>" class="form-control" data-id="<?php echo $id ?>" min="1">
					</td>
					<td class="item_subtotal"><?php echo $subTotal;?></td>
					<td class="item_action text-center">
						<button class="btm btn-danger item-remove" data-id="<?php echo $id ?>">Remove from cart</button>
					</td>
				</tr> 
				<?php } ?>
			</tbody>
			<tfoot>
				<tr>
					...
					<td class="text-center"><a href="./checkout.php" class="btn btn-primary">Proceed to checkout</a>
					</td>
				</tr>
			</tfoot>
			 <?php } else {
