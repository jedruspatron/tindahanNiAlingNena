...
$staff_email = 'alingnenatindahan123@gmail.com';
$customer_email = $_SESSION['user']['email'];          //
$subject = 'Tindahan Ni Aling Nena - Order Confirmation';
...
try {
    ...
    $mail->Password = 'tuittDay1105';                     // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom($staff_email, 'Tindahan ni Aling Nena');
